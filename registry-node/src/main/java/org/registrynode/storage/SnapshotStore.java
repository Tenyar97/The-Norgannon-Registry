...
public class SnapshotStore {
    ...
    public StoreResult put(SnapshotRecord record) {
        ...
        try {
            ...
            if (record.getSequence() <= currentSeq) {
                log.fine("Stale record ignored — characterId=" + characterId +
                         " incoming=" + record.getSequence() +
                         " current=" + currentSeq);
            ...
            log.info("Record stored — characterId=" + characterId +
    ...
    public List<String> listCharacterIds() {
        ...
        try (DirectoryStream<Path> stream =
                Files.newDirectoryStream(dataDir, "*.json")) {
